import 'package:language_picker_native_tongue/src/utils/typedefs.dart';
import 'package:language_picker_native_tongue/src/utils/my_alert_dialog.dart';
  ...
  void initState() {
    ...
    if (widget.locales.isNotEmpty) {
      for (final language in Languages.defaultLanguages) {
        if (widget.locales.any((e) => e == language.localeIntl)) {
